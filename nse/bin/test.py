...
def main():
    ...
    merge['Spread_cm'] = current['Settle Price'] - mid['Settle Price']
    merge['fairprice'] = current['fairprice'].apply(lambda x: round(x,2))
    merge['Diff'] = merge['fairprice'] - current['Settle Price']

    merge['current_price'] = current['Settle Price']
    merge['middle_price'] = mid['Settle Price']
